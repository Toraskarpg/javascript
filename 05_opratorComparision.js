...
// diff between == compare the value, it will do implicit cobersion and then compare value, check the value and === operator
// what is the feature of figma template
// string operators
// implicit coversion-->convert string to number
// explicit concersion--> if developer want covert data type like number to string          
